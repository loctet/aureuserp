...
class EmployeeMaterialTransactionsSentRelationManager extends RelationManager
{
    protected static string $relationship = 'materialInventoryTransactionsSent';

    public static function getTitle(Model $ownerRecord, string $pageClass): string
    {
        return __('material-inventory::filament/resources/material-item.relation-managers.employee-sent.title');
    }
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('toEmployee.name')->label('To'),
